<%@ Page Language="C#" AutoEventWireup="true" CodeFile="announcementdetail.aspx.cs" Inherits="UI_storepage_announcementdetail" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="panel-footer">
            ...
            <div class="panel panel-default" title="公告详情">
                <div class="panel-heading">
                    <h3 class=".text-info">公告详情</h3>
                </div>
                <div class="form-group">
                <h4><asp:Label ID="labname" runat="server" ></asp:Label></h4>
                <h5><asp:Label ID="labtime" runat="server" ></asp:Label>&emsp;&emsp;<asp:Label ID="labowner" runat="server" ></asp:Label></h5>
                </div>
                <div class="form-group">
                <label for="exampleInputEmail1">内容：</label><asp:TextBox ID="tbxdetail" CssClass="form-control" ReadOnly="true" runat="server" Rows="9" TextMode="MultiLine"></asp:TextBox>
                </div>
                <asp:Button ID="btnreturn" Text="返回公告" runat="server" onclick="btnreturn_Click" CssClass="btn btn-primary"/>
