<%@ Page Language="C#" AutoEventWireup="true" CodeFile="stockoutdetail.aspx.cs" Inherits="UI_goodspage_stockoutdetail" %>
    ...
    <form id="form1" runat="server">
        ...
        <div class="col-md-10">
                ...
                <div class="panel panel-default" title="修改">
                    ...
                    <div class="form-inline">
                        <div class="form-group">
                        <label for="exampleInputEmail1">出货量</label><asp:TextBox ID="tbxgcount" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                        <div class="form-group">
                        <label for="exampleInputEmail1">特殊处理价格</label><asp:TextBox ID="tbxprice" CssClass="form-control" runat="server" ></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
