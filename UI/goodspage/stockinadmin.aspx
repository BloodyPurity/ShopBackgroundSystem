<%@ Page Language="C#" AutoEventWireup="true" CodeFile="stockinadmin.aspx.cs" Inherits="UI_goodspage_stockinadmin" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="col-md-10">
            ...
            <div class="panel panel-default" title="入库一览">
                <div class="panel-heading">
                    <h3 class=".text-info">入库一览</h3>
                </div>
                <asp:GridView ID="GridView1" runat="server"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="uaccount" HeaderText="进货人" ReadOnly="True" />
                        <asp:BoundField DataField="count" HeaderText="存量" />
