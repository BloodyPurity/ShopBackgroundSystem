<%@ Page Language="C#" AutoEventWireup="true" CodeFile="stockout.aspx.cs" Inherits="UI_goodspage_stockout" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="col-md-10">
            ...
            <div class="col-md-9">
                <div class="panel panel-default" title="我的出库">
                    <div class="panel-heading">
                        <h3 class=".text-info">我的出库</h3>
                    </div>
                    <asp:GridView ID="GridView1" runat="server"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="count" HeaderText="出库量" />
            ...
            <div class="col-md-3">
                <div class="panel panel-default" title="出库">
                    <div class="panel-heading">
                        <h3 class=".text-info">出库</h3>
                    </div>
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                <label for="exampleInputPassword1">特殊处理价格：</label>
                                <asp:TextBox ID="tbxPrice" runat="server" class="form-control" placeholder="正常情况勿填"></asp:TextBox>
                            </div>
                            <div class="form-group">
                        ...
                        <div class="panel-footer">注意：如果特殊价格不填则为正常售价。特殊处理包括过期、变质等等。特殊处理不参与打折。</div>
                </div>
                </div>
        </div>
