<%@ Page Language="C#" AutoEventWireup="true" CodeFile="stockindetail.aspx.cs" Inherits="UI_goodspage_stockindetail" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <div class="col-md-10">
                ...
                <div class="panel panel-default" title="修改">
                    <div class="panel-heading">
                        <h3 class=".text-info">入库信息</h3>
                    </div>
                    <div class ="form-inline">
                        ...
                        <div class="form-group">
                          <label for="exampleInputEmail1">供货商</label><asp:TextBox ID="tbxprovider" CssClass="form-control" runat="server" ReadOnly="true"></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-inline">
                        <div class="form-group">
                        <label for="exampleInputEmail1">进货量</label><asp:TextBox ID="tbxgcount" CssClass="form-control" runat="server"></asp:TextBox>
                        </div>
                        <div class="form-group">
                        <label for="exampleInputEmail1">进价</label><asp:TextBox ID="tbxprice" CssClass="form-control" runat="server" ></asp:TextBox>
                        </div>
                    </div>
                    <div class="form-group">
